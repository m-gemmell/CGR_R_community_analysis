...
We have a saved `ggplot2` object but now we need to save it as a image file and display it.
...
Additionally, we will be able to detect class that have been depleted in the media samples versus the environmental sample.
...
It appears that more difference is caused by the medias than the sites.
